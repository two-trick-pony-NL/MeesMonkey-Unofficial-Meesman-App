...
const RendementScreen = ({ data, graphdata, onBackToPortfolio }) => {
  ...
  const totalReturnFloat = (parseFloat(totalReturnString.replace(",", "").replace("%", ".")) / 10);
      ...
      <SafeAreaView>
        ...
        <View style={styles.numberCardsRow}>
          <View style={styles.numberCardSmall}>
            <NumberCard explainerText={'Groei'} bigNumber={totalReturnString} />
          </View>
        ...
        <View style={styles.numberCardsRow}>
          ...
          <View style={styles.numberCardSmall}>
          <NumberCard explainerText={'Transactiekosten'} bigNumber={'€ ' + totalTransactiekosten} />
          </View>
        </View>
